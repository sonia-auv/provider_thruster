...
![Docker Image CI - Master Branch](https://github.com/sonia-auv/provider_thruster/workflows/Docker%20Image%20CI%20-%20Master%20Branch/badge.svg)
![Docker Image CI - Develop Branch](https://github.com/sonia-auv/provider_thruster/workflows/Docker%20Image%20CI%20-%20Develop%20Branch/badge.svg?branch=develop)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/sonia-auv/provider_thruster)
![Average time to resolve an issue](https://isitmaintained.com/badge/resolution/sonia-auv/provider_thruster.svg)
...
```bash
    git clone git@github.com:sonia-auv/provider_thruster.git
```
